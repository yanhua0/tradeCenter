...
<div id="base" class="">
    ...
    <div id="u175" class="ax_文本">
        ...
        <div id="u176" class="text">
            <p><span>报价</span><span>信息</span><span></span></p>
        </div>
    </div>
    <!-- Unnamed (横线) -->
    ...
    <div id="u147" class="ax_文本">
        ...
        <div id="u148" class="text">
            ...
            <p><span style="color:#000000;">中标信息公布后，未中标供应商的报价保证金将自动返回供应商保证金虚拟账户；</span></p>
            <p><span style="color:#000000;">中标供应商与电厂签订采购合同时，供应商按电厂履约保证金要求及签约量缴纳履约保证金；在双方完成合同履约后，电厂将解冻履约保证金，履约保证金将返还供应商保证金虚拟账户。</span>
            </p>
    ...
    <div class="container" id="container">
        ...
        <form id="form" action="savebaojia" method="post">
            <input type="hidden" name="bzj" value="${price}">
            ...
            <div class="panel-body">
                <div class="panel-body" id="dasd">
                    ...
                    <div>
                        发站(发货港口)：<input class="bj" id="bj3-input" type="text" name="sendArea"
                                        value="${baojia.sendArea}">
                        <!--  b1：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="bj" type="text"> -->
                        运费单价(元/吨):<input class="bj" id="bj4-input" type="text" name="transportPrices"
                                         value="${baojia.transportPrice}"><br>
                        <!--  b2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="bj" type="text">
                         b3:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="bj" type="text"> -->
                    </div>
                    <br>
                    <div class="advice">
                        <div>
                    ...
                    <input type="hidden" id="default" value="${baojia.number}">
                    <input type="hidden" id="id" name="id" value="${baojia.id}">
                    <c:if test="${buyInfo.baojiaPrice==-1}">
    ...
    <script>
        $(function () {
            ...
            $("#confim").click(function () {
                if ($("#bj1-input").val().length == 0 || $("#bj2-input").val().length == 0 || $("#bj3-input").val().length == 0 || $("#bj4-input").val().length == 0 || $("#bj5-input").val().length == 0) {
                    alert("请完善对煤质的要求");
                    return false;
                }
                $("#form").submit();
