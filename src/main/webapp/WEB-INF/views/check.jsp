...
<body>
<div class="container">
    <div class="title">采购信息审核</div>
    <hr>
    <div class="panel">

        <div class="panel-body">
            <table class="table table-condensed table-hover table-layout:fixed;" style="word-break:break-all; word-wrap:break-all;">
                <thead class="thr">
                <tr id="fir">
                    ...
                    <td>
                        ...
                        <c:if test="${buyInfo.checkLevel!=2}">
                            <c:if test="${users.role.action.equals('电厂审核')}">
                                <a href="check1?id=${buyInfo.id}" target="content">审核</a>
                            </c:if>
                            <c:if test="${users.role.action.contains('分子公司')}">
                                <a href="check2?id=${buyInfo.id}" target="content">审批</a>
                            </c:if>
                        </c:if>
