...
<div id="das">
<img src="static/images/采购审核/u128.png"/><span id="te">执行审批记录</span>
<img id="pic" src="static/images/比价采购-审核操作/u174_line.png" alt=""></div>
</div>
     ...
     <tbody>
     <c:forEach items="${bu}" varStatus="sta" var="bu">
      <tr>
        <td>${sta.index+1}</td>
        <td>${bu.users.name}</td>
  ...
  <div class="advice">
<div>
备注：<label for=""><textarea name="advice" class="form-control"></textarea></label><br>
 <input type="button" id="confirm" class="btn btn-primary" value="审核通过" >
